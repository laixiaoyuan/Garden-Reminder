...
public class PlantDBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        sql = "INSERT or replace INTO plantCollection (plantName, photoPath, waterInterval, sun, fertilizeTime, fertilizer, pestsAndDiseases, bloomTime) VALUES('Torch Lily','http://www.homedepot.com/catalog/productImages/400/f2/f230099a-932b-4757-9911-20507459bd32_400.jpg',14,'Full sun','when planting','Mix with compost when planting','Insect and disease problems are uncommon.','Summer')";
        db.execSQL(sql);
        ...
        db.execSQL(sql);
        sql = "INSERT or replace INTO plantCollection (plantName, photoPath, waterInterval, sun, fertilizeTime, fertilizer, pestsAndDiseases, bloomTime) VALUES('Verberna','http://www.homedepot.com/catalog/productImages/400/10/1085c1ad-1f93-431a-b979-e85e1e205357_400.jpg',5,'Full sun to 1/2 day shade','every spring','complete fertilizer such as 16-4-8','leafminers, aphids, mites','From spring to fall')";
        db.execSQL(sql);
...
//        SQLiteDatabase db = SQLiteDatabase.openDatabase(mypath, null, SQLiteDatabase.CREATE_IF_NECESSARY);
    ...
    public Plant fetchPlantWithId(int _id){
        ...
        Plant plant= new Plant(id, plantName, plantPicPath, date, waterInterval, lastWater);
