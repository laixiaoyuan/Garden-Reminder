...
public class PlantCollectionDBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        sql = "INSERT or replace INTO plantCollection (plantName, photoPath, waterInterval, sun, fertilizeTime, fertilizer, pestsAndDiseases, bloomTime) VALUES('peony','http://g01.a.alicdn.com/kf/HTB11GSgJpXXXXb4XXXXq6xXFXXX9/Free-shipping-6-PackS-120-font-b-Seeds-b-font-blue-white-black-pink-red-font.jpg',2,'Full sun','every spring','ow nitrogen fertilizer (5-10-10)','gray mold,Peony blotch,Slugs Or Snails','mid-spring')";
        db.execSQL(sql);
